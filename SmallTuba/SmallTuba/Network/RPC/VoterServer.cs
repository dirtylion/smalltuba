namespace SmallTuba.Network.RPC
{
	...
	public class VoterServer
	{
		...
		public delegate Person CprToPersonRequest(string clientName, string cpr);
		...
		private object RequestHandler(object o)
		{
			...
			switch (keyword)
			{
				case Keyword.GetPersonFromCpr:
					...
					{
						Person person = this.cprToPersonRequest.Invoke(request.GetSender, request.GetValue.ToString());
